...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    setTimeout(function() {
        const url = "https://youtu.be/R5cbxTPZNL0?si=4QEiAaxDWZmv1J2u"
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = 'Ya dime la verdad :3';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si :\'v';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Solo piensalo jaja';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Si dices que no estaré muy triste jaja';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy triste D:';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy muy muy triste xDe';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Vale, ya dejaré de preguntar... B|';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'Es broma, POR FAVOR DI SÍ jaja';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'por favooooooor jajaja';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
